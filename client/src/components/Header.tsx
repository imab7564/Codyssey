  ...
  return (
    <div>
      ...
      <nav className="w-full h-[60px] bg-gray-400 dark:bg-gray-900 text-white p-3 flex justify-between items-center">
        <Link to="/">
          <h2 className="font-bold select-none text-gray-800 dark:text-white">Codyssey</h2>
        </Link>
        <HoverCard>
          ...
          <HoverCardContent className="w-80">
            <div className="flex justify-between space-x-4">
              ...
              <div className="space-y-1">
                <h4 className="text-sm font-semibold cursor-pointer" onClick={() => window.open('https://github.com/imab7564/Codyssey', "_blank")}>Codyssey</h4>
                <p className="text-sm">
